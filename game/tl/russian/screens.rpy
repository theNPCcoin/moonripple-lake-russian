...
translate russian strings:
    ...
    old "Textbox Background"
    new "Фон текстового окна"
    ...
    old "Femboys/Futanari"
    new "Фембои/Футанари"

    # game/screens.rpy:904
    old "Animated BGs (few)"
    new "Анимированные фоны (немного)"
    ...
    new "Пропускает диалог, пока удерживается."
    ...
    new "Включает/выключает пропуск диалога."
    ...
    new "Включает/выключает {a=https://www.renpy.org/l/voicing}озвучивание{/a}."
    ...
    old "Mouse Wheel Up"
    new "Колёсико мыши вверх"

    # game/screens.rpy:1181
    old "Mouse Wheel Down"
    new "Колёсико мыши вниз"
